...
const updateProductById = async (req, res) => {
  try {
    ...
    return res.json({ message: "Product updated successfully!!", updatedFields: updateQuery });
  } catch (error) {
...
module.exports={getAllCategories,createCategories,getAllProducts,createProduct,upload,createProduct,getProductById,updateProductById,deleteProduct}